...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bb2qYeZ-.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C3cvo9CO.js").then((n2) => n2.a),
...
export {
  ...
  React as T,
  jsxRuntimeExports as U,
  isModuleNotFoundError as V,
  useHydrated as W,
  escapeHtml as X,
  getAssetCrossOrigin as Y,
